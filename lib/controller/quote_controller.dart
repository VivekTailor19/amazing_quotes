...
class QuoteController extends GetxController
{
 ...
 Future<void> filterQuotesAccordingToCategory(category)
 async {
  filterData.value  = await Quote_DB_Helper.quote_db_helper.fetchDATAFromDatabase(category: category);
 }
 ...
 Future<void> filterQuotesAccordingToAuthor(author)
 async {
  filterData.value  = await Quote_DB_Helper.quote_db_helper.fetchDATAFromDatabase(author: author);
 }


 RxList authorList = [].obs;
 Future<void> fetchAuthorList()
 async {
  authorList.value = [];
  List tempLIST = await Quote_DB_Helper.quote_db_helper.fetchDISTINCTAuthors();
  String tempAuthor = "";
  ...
  print("authorLIST------  ${authorList.length}  ---------========== ${authorList.value}");
 ...
 */
 ...
 //
   ...
   //      ======================================       ADD QUOTE ==============================================
//             print("press insert quote---------------------");
//             QuoteModel model = QuoteModel();
//             for(int i = 0 ; i < control.tempquoteLIST.length ;  i++)
//             {
//
//               model = control.tempquoteLIST[i];
//               print("==${control.tempquoteLIST.length}========== data no ==========  $i");
//               Quote_DB_Helper.quote_db_helper.insertQuote(model);
//             }
//
// /*            control.tempquoteLIST.map((e) async => await Quote_DB_Helper.quote_db_helper.insertQuote(
//                 QuoteModel(category: e.category,quote: e.quote,fav: e.fav,author: e.author))).toList();
//
//  */
...
//      ======================================       DELETE QUOTE     ==============================================
              //  int tempId  = 0 ;
              // for(int i = 0 ; i<control.quoteList.length ;  i++)
              //   {
              //     tempId = control.quoteList[i]['id'] ;
              //     print("============ tempId ==========  $tempId");
              //     Quote_DB_Helper.quote_db_helper.deleteQuotes(tempId);
              //   }

//             ======================================       ADD CATEGORY =============================================

//    List<String> tempCategoryList = [ "Motivational","Passion", "Life", "Powerful", "Believe", "Positivity","Success"];

    //         for(int i = 0 ; i < control.tempCategoryList.length ; i++)
    //           {
    //             String tempTEXT = control.tempCategoryList[i];
