...
class View_FilteredQuote_Screen extends StatefulWidget {
  ...
  @override
  State<View_FilteredQuote_Screen> createState() => _View_FilteredQuote_ScreenState();
}
          ...
          () =>  ListView.builder(
            ...
            itemBuilder: (context, index) {
               ...
               return GestureDetector(
                 ...
                 onTap: () {
                   tquote = TextEditingController(text: control.filterData[index]['quote']);
                   Get.defaultDialog(title: "Update Quote",content: Column(
                     children: [
                       SizedBox(height: 1.5.h,),
                       CustomTextField(hint: "Quote",kboard: TextInputType.text,controller: tquote),
                       SizedBox(height: 2.h,),
                       Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                         children: [
                           IconButton(onPressed: () async {

                             Quote_DB_Helper.quote_db_helper.deleteInQuoteTABLE(control.filterData[index]['id']);

                             what == "category"
                                 ? control.filterQuotesAccordingToCategory(title)
                                 : control.filterQuotesAccordingToAuthor(title);
                           ...
                           IconButton(onPressed: () async {
                             ...
                             QuoteModel model = QuoteModel(
                               ...
                               category: control.filterData[index]['category'],
                               fav: control.filterData[index]['fav'],
                               id: control.filterData[index]['id'],
                               quote: tquote.text
                             );

                             await Quote_DB_Helper.quote_db_helper.updateInQuoteTABLE(model);
                 ...
                 child: Container(
                   ...
                   decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.w),
                       image: DecorationImage(image: AssetImage("${control.bgImgList[control.imgIndex.value]}"),fit: BoxFit.cover),
                   ...
                   child: Column(
                     children: [
                       SizedBox(height: 3.h,),
                       Text("${control.filterData[index]['quote']}",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 13.sp,color: Colors.white),maxLines: 5,overflow: TextOverflow.ellipsis,textAlign: TextAlign.center,),
                       Spacer(),
                       Row(mainAxisAlignment: MainAxisAlignment.end,
                         children: [
                           Text(what == "category"
                               ...
                               ,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 15.sp,color: Colors.white),textAlign: TextAlign.center,),
                           SizedBox(width: 5.w,),
                         ],
                       ),
                       SizedBox(height: 1.5.h,),
